...
test_normal_drone_ds, shape = data.load_it(
    split="test_normal_drone", label_encoding="one_hot"
)
test_normal_fixedwing_ds, shape = data.load_it(
    split="test_normal_fixedwing", label_encoding="one_hot"
)
test_petrol_fixedwing_ds, shape = data.load_it(
    split="test_petrol_fixedwing", label_encoding="one_hot"
)
test_racing_drone_ds, shape = data.load_it(
    split="test_racing_drone", label_encoding="one_hot"
)
test_nature_chernobyl_ds, shape = data.load_it(
    split="test_nature_chernobyl", label_encoding="one_hot"
)
test_false_positive_ds, shape = data.load_it(
    split="test_false_positives_drone", label_encoding="one_hot"
)
